                ...
                <form class="bg-white lg:w-[740px] shadow-lg rounded-sm border border-gray-100 p-5 lg:col-span-2">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="sm:col-span-1">
                            <label class="block text-sm font-medium text-[#294F78] mb-2">Ваше имя *</label>
                            <input type="text" name="name" placeholder="Ваше имя" class="w-full px-4 py-2.5 border border-gray-300 rounded focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700">
                        </div>
                        <!-- Phone -->
                        <div class="sm:col-span-1">
                            <label class="block text-sm font-medium text-[#294F78] mb-2">Укажите телефон или e-mail *</label>
                            <input type="tel" name="contact" placeholder="+375 (__) ___-__-__" class="w-full px-4 py-2.5 border border-gray-300 rounded focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700">
                        </div>
                        <!-- Email -->
                        <div class="sm:col-span-1">
                        ...
                        <div class="flex flex-wrap items-center gap-x-6 gap-y-2">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <?php if ($cf_viber_url): ?>
                                    ...
                                    ; ?>" alt="viber" class="w-[28px] h-[28px]">
                                <?php else: ?>
                                    <img src="<?php echo
                                        esc_url($theme_uri . '/img/viber.svg')
                                    ; ?>" alt="viber" class="w-[28px] h-[28px]">
                                <?php endif; ?>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                ...
                                <?php if ($cf_telegram_url): ?>
                                    ...
                                    ; ?>" alt="telegram" class="w-[28px] h-[28px]">
                                <?php else: ?>
                                    <img src="<?php echo
                                        esc_url($theme_uri . '/img/telegram.svg')
                                    ; ?>" alt="telegram" class="w-[28px] h-[28px]">
                                <?php endif; ?>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                ...
                                <?php if ($cf_whatsapp_url): ?>
                                    ...
                                    ; ?>" alt="whatsup" class="w-[28px] h-[28px]">
                                <?php else: ?>
                                    <img src="<?php echo
                                        esc_url($theme_uri . '/img/wu.svg')
                                    ; ?>" alt="whatsup" class="w-[28px] h-[28px]">
                                <?php endif; ?>
                            </label>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="message" rows="1" placeholder="Опишите вашу задачу" class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none mt-1"></textarea>
                    </div>
