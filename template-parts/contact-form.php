    ...
    <section id="contact-form" class="relative overflow-hidden bg-[url('<?php echo get_template_directory_uri(); ?>/img/bg-7.png')] bg-cover bg-center bg-no-repeat contact-form-section">
                    ...
                    <div class="mb-2 sm:flex-col md:flex md:flex-row items-center">
                        ...
                        <div class="flex flex-wrap items-center gap-x-6 gap-y-2">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <img src="<?php echo get_template_directory_uri(); ?>/img/viber.svg" alt="viber" class="w-[28px] h-[28px]">
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="contact_method" value="telegram" class="w-4 h-4 text-blue-600 contact-method-radio mr-2">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/telegram.svg" alt="telegram" class="w-[28px] h-[28px]">
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="contact_method" value="whatsapp" class="w-4 h-4 text-blue-600 contact-method-radio mr-2">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/wu.svg" alt="whatsup" class="w-[28px] h-[28px]">
                            </label>
                        </div>
                    </div>
